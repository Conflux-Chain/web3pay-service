...
//
// Solidity: function initialize(address appFactory_) returns()
func (_AppRegistry *AppRegistryTransactor) Initialize(opts *bind.TransactOpts, appFactory_ common.Address) (*types.Transaction, error) {
	return _AppRegistry.contract.Transact(opts, "initialize", appFactory_)
}

// Initialize is a paid mutator transaction binding the contract method 0xc4d66de8.
//
// Solidity: function initialize(address appFactory_) returns()
func (_AppRegistry *AppRegistrySession) Initialize(appFactory_ common.Address) (*types.Transaction, error) {
	return _AppRegistry.Contract.Initialize(&_AppRegistry.TransactOpts, appFactory_)
}

// Initialize is a paid mutator transaction binding the contract method 0xc4d66de8.
//
// Solidity: function initialize(address appFactory_) returns()
func (_AppRegistry *AppRegistryTransactorSession) Initialize(appFactory_ common.Address) (*types.Transaction, error) {
	return _AppRegistry.Contract.Initialize(&_AppRegistry.TransactOpts, appFactory_)
}
...
//
// Solidity: event Created(address indexed app, address indexed operator, address indexed owner, address apiWeightToken)
